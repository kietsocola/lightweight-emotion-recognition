...
\begin{itemize}[]
    ...
    \[ I_{\text{out}} = \frac{I_{\text{in}} - I_{\min}}{I_{\max} - I_{\min}} \times 255 \]
      ...
      \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{img/thuattoan-01.png} % Đường dẫn tương đối
    \label{fig:emotion_distribution}
\end{figure}
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{img/thuattoan-02.png} % Đường dẫn tương đối
